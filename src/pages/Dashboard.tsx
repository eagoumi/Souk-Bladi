...
import { LayoutDashboard, ShoppingBag, Users as UsersIcon, Settings, BarChart3, Plus, Search, Bell, Menu, LogOut, ChevronRight, Globe, ShieldAlert, ShoppingCart, Heart } from 'lucide-react';
...
export const Dashboard: React.FC = () => {
    ...
    const menuItems = [
        ...
        { id: 'cart', label: t('common.cart'), icon: ShoppingCart, path: '/cart', end: false, hidden: user?.role !== 'buyer' },
        { id: 'my-coops', label: t('dashboard.nav.myCoops'), icon: Heart, path: '/dashboard/cooperatives', end: false, hidden: user?.role !== 'buyer' },
        ...
        { id: 'customers', label: t('dashboard.nav.customers'), icon: UsersIcon, path: '/dashboard/customers', end: false, hidden: user?.role === 'buyer' },
