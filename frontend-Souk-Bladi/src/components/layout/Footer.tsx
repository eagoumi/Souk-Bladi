                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
                    ...
                    <div>
                        ...
                        <ul className="space-y-3 text-sm">
                            <li><Link to="/products?category=cosmetique" className="hover:text-primary-500 transition-colors">Cosmétiques Naturels</Link></li>
                            <li><Link to="/products?category=alimentaire" className="hover:text-primary-500 transition-colors">Produits du Terroir</Link></li>
                            <li><Link to="/products?category=artisanat" className="hover:text-primary-500 transition-colors">Artisanat & Déco</Link></li>
                            <li><Link to="/gift-sets" className="hover:text-primary-500 transition-colors">{t('nav.giftsets')}</Link></li>
                            <li><Link to="/pricing" className="hover:text-primary-500 transition-colors">Tarifs Promotion</Link></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3 text-sm">
                            ...
                            <li><Link to="#" className="hover:text-primary-500 transition-colors">Livraison & Retours</Link></li>
                            <li><Link to="#" className="hover:text-primary-500 transition-colors">FAQ</Link></li>
                    ...
                    <div>
                        ...
                        <ul className="space-y-4 text-sm">
                            <li className="flex items-start gap-3">
                                ...
                                <span className="text-gray-400">123 Avenue Mohammed V,<br />Rabat, Maroc</span>
                            </li>
                            <li className="flex items-center gap-3">
                                <div className="p-2 bg-gray-800 rounded-lg text-primary-500">
                                    <Phone size={16} />
                                </div>
                                <span className="text-gray-400">+212 5 37 00 00 00</span>
                            </li>
                            <li className="flex items-center gap-3">
                                <div className="p-2 bg-gray-800 rounded-lg text-primary-500">
                                    <Mail size={16} />
