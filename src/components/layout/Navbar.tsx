...
import { Search, ShoppingCart, ShoppingBag, Heart, User, Menu, X, Globe, LogOut, LayoutDashboard } from 'lucide-react';
                            ...
                            {user ? (
                                <div className="relative group">
                                    ...
                                    <div className="absolute right-0 mt-4 w-56 glass rounded-xl py-2 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 transform origin-top-right z-50 translate-y-2 group-hover:translate-y-0">
                                        ...
                                        {user.role === 'buyer' && (
                                            <Link to="/dashboard/orders" className="block px-5 py-2.5 text-sm text-gray-700 hover:bg-gray-50 hover:text-primary-600 flex items-center gap-2 transition-colors">
                                                <ShoppingBag size={16} /> {t('nav.myOrders')}
                                            </Link>
                                        )}
                                        <Link to="/dashboard/settings" className="block px-5 py-2.5 text-sm text-gray-700 hover:bg-gray-50 hover:text-primary-600 flex items-center gap-2 transition-colors">
